                        ...
                        <div class="tab-content">
                            ...
                            <div id="w4-confirm" class="tab-pane">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="file" class="form-control" name="foto" id="w4-foto" accept="image/*" id="file" onchange="ValidateSize(this)">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="file" class="form-control" name="kk" id="w4-foto" accept="image/*" id="file" onchange="ValidateSize(this)">
                                    </div>
                                </div>
                                <div class="form-group">
