 ...
 <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active">
          <a href="<?php echo base_url().'user/siswa_dash'?>">
            <i class="fa fa-home"></i> <span>Dashboard2</span>
            <span class="pull-right-container">
              <small class="label pull-right"></small>
            </span>
          </a>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
           <li><a href="<?php echo base_url('user/profil')?>"><i class="fa fa-thumb-tack"></i> Profil</a></li>
           <li><a href="<?php echo base_url().'user/tulisan'?>"><i class="fa fa-wrench"></i> Edit Profil </a></li>
           <li><a href="<?php echo base_url().'siswa_detail'?>"><i class="fa fa-wrench"></i> Profil tes</a></li>
          </ul>
        </li>
